...
DB_NAME = os.environ.get("DB_NAME", "MS DZULQURNAIN")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Vsmi:bot@cluster0.hcoo8gc.mongodb.net/?retryWrites=true&w=majority")
