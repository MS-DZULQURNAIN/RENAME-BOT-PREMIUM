...
async def start(client, message):
    ...
    try:
        ...
        txt=f"""Halo {message.from_user.first_name }❤ \n\n
...
async def tutor(bot,update):
        ...
        tbutton = InlineKeyboardMarkup([[InlineKeyboardButton("KEMBALI", callback_data="tback")]])
        await update.message.edit(text = ttutor, reply_markup = tbutton)
